export async function handleAthlete() {
    ...
    if (groupLink) {
        groupLink.addEventListener("click", async function (event) {
            ...
            if (container) {
                container.innerHTML = `<h2>Welcome, Athlete!</h2>${groupHTML}`;
            }
        ...
        matesHTML += `</ul>
            ...
            if (athleteGroupMates) {
                athleteGroupMates.innerHTML = `<h4>Athletes of this group:</h4>${matesHTML}`;
            }
            ...
            if (changeGroupButton) {
                ...
                groupsHTML += `</table>`;
                    ...
                    if (groupsChange) {
                        groupsChange.innerHTML = `<h4>Optional Groups:</h4>${groupsHTML}`;
                    }
    ...
    if (personalDataLink) {
        ...
        if (groupsChange) {
            ...
            if (container) {
                container.innerHTML = `<h2>Your personal data:</h2>${personalDataHTML}`;
            }
